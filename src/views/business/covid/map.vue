<template>
  <div>
    ...
    <el-row :gutter="10">
      <!-- echarts图表 -->
      <el-col :span="12"><div id="myChart" :style="{width: '800px', height: '600px'}"></div></el-col>
      <el-col :span="12"><div class="grid-content bg-purple-light">
        <el-tabs type="border-card">
          <!-- 疫情概览 -->
          <el-tab-pane label="疫情概览">
            <el-table height="520" border :data="info" style="width: 900px">
          ...
          <el-tab-pane label="Top10城市">
            <el-table height="520" border :data="top10" style="font-size: 10px;width: 900px">
