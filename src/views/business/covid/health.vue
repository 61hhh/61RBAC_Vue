    ...
    <el-card style="height: 590px;">
      ...
      <h5 style="margin: 0px;padding: 0px;">
        ...
        <div style="float: right;margin-bottom: 10px;vertical-align: center;">
          ...
          <el-button @click="onSubmit" size="small" type="primary" style="margin-top: 5px;" v-if="!reported">立即打卡</el-button>
              ...
              <ul>
                ...
                <li>健康状况：
                  <div style="float: right">
                    ...
                    <el-tag v-if="item.situation===1" size="small" effect="dark" type="danger">发热</el-tag>
                    <el-tag v-if="item.situation===2" size="small" effect="dark" type="warning">其他情况</el-tag>
                  </div>
                </li>
              </ul>
            </div>
...
<!--                    <el-date-picker disabled v-model="nowTime"-->
